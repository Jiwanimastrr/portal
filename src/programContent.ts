...
export const PROGRAM_GUIDES: ProgramGuide[] = [
  ...
  },
  {
    slug: 'speaking',
    label: '이중언어 스피킹',
    title: '태전동 초등 스피킹·영어 발표 수업 | 윌그로우 태전2',
    description: '윌그로우 태전2는 평소 스피킹 수업과 발표 수업을 운영합니다. 이중언어 선생님과 배우는 초등 영어, 자체교재와 상담 안내를 확인하세요.',
    heading: '내 생각을 말하는 스피킹·발표 수업',
    answer: '윌그로우어학원 태전2국제캠퍼스는 평소 스피킹 수업과 발표 수업을 운영합니다. 이중언어를 사용하는 선생님들과 스피킹을 배우며, 자체교재로 읽고 들은 영어를 직접 말하고 표현하는 학습으로 연결합니다.',
    ...
    sections: [
      ...
      { heading: '말하기와 발표·표현 활동을 연결합니다', paragraphs: ['윌그로우 태전2는 평소 스피킹 수업과 발표 수업을 운영합니다. 읽기·듣기로 배운 내용을 말하기·쓰기로 연결하며, 사람들 앞에서 영어로 표현하는 활동도 함께 안내합니다.', '문장을 따라 말한 뒤에는 자기 생각을 담아 표현해보는 경험이 필요합니다. 어떤 활동을 하는지와 함께 아이가 직접 말할 기회가 어떻게 주어지는지를 상담에서 확인해 보세요.'] },
    ...
    faqs: [
      ...
      { question: '평소 수업에서도 영어 발표를 하나요?', answer: '네. 평소 스피킹 수업과 발표 수업을 운영합니다. 발표 활동의 구성과 일정은 아이의 배정 과정에 맞춰 입학 상담에서 안내합니다.' },
