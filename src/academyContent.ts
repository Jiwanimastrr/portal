...
export const ACADEMY_LEARNING_SUMMARY = '윌그로우 자체교재로 초1 파닉스부터 중등 영어까지 이어갑니다. 이중언어 선생님의 스피킹 수업과 아이가 직접 설명하는 문법 학습으로, 배운 영어를 말하고 이해하는 힘을 기릅니다.';

export const ACADEMY_FAQS = [
  {
    id: 'taejeon-campus-consolidation',
    question: '태전1국제캠퍼스와 태전2국제캠퍼스는 어떤 관계인가요?',
    answer: '태전1국제캠퍼스는 태전2국제캠퍼스로 통합 이전했습니다. 현재 수업과 입학 상담은 윌그로우어학원 태전2국제캠퍼스에서 안내합니다. 방문 주소는 경기도 광주시 태성로 130-1, 건물 3층 304호입니다.',
  },
  {
    id: 'academy-name',
  ...
  },
  {
    ...
    answer: '윌그로우어학원 태전2국제캠퍼스는 자체교재를 사용하며 초등 1학년 파닉스부터 시작합니다. 이중언어 선생님의 스피킹 수업, 아이가 직접 설명하는 문법 학습과 함께 읽기·듣기·말하기·쓰기를 연결합니다. 현재 학습 상태에 맞는 과정은 입학 상담에서 안내합니다.',
  },
  {
  ...
  {
    id: 'own-textbook',
    question: '윌그로우 태전2는 어떤 영어 교재를 사용하나요?',
    answer: '윌그로우어학원 자체교재를 사용합니다. 초등 1학년 파닉스부터 시작하며 아이의 현재 학습 상태에 맞는 과정과 교재를 상담에서 안내합니다.',
  },
  {
    id: 'bilingual-speaking',
    question: '스피킹 수업은 어떤 선생님이 진행하나요?',
    answer: '이중언어를 사용하는 선생님들이 스피킹 수업을 진행합니다. 읽고 들은 영어를 자기 생각을 말하고 표현하는 학습과 연결합니다.',
  },
  {
    id: 'speaking-presentations',
    question: '평소 수업에서도 영어 발표를 하나요?',
    answer: '네. 윌그로우 태전2는 평소 스피킹 수업과 발표 수업을 운영합니다. 이중언어를 사용하는 선생님들과 스피킹을 배우며, 발표 활동의 구성과 일정은 아이의 과정에 맞춰 상담에서 안내합니다.',
  },
  {
    id: 'explain-grammar',
    question: '문법 수업에서는 무엇을 중요하게 보나요?',
    answer: '아이가 배운 문법을 직접 설명할 수 있도록 지도합니다. 무엇이 정답인지에 더해 왜 그 형태를 사용하는지 설명하며 문법을 이해하는 학습을 지향합니다.',
  },
  {
    id: 'elementary-to-middle',
    question: '초등부터 중등까지 이어서 영어를 배울 수 있나요?',
    answer: '네. 윌그로우 태전2는 초등 1학년 파닉스부터 초등 영어, 중등 문법·독해와 학교별 내신·수행평가까지 이어지는 학습을 상담합니다. 다음 과정과 반 배정은 아이의 현재 학습 상태를 살펴본 뒤 안내합니다.',
  },
  {
    id: 'first-booking',
